...
export default async function openDiscussionDashboard(driver) {
  describe("open discussion tab", function () {
    ...
    it("should open discussion dashboard", async function () {
      // Wait for the button element to be located
      const discussionButton = await driver.wait(
        until.elementLocated(
          By.xpath("/html/body/div/div/div/div[1]/button[3]")
        ),
