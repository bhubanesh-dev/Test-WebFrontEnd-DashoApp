...
export default async function openAssignmentDashboard(driver) {
  describe("open assignment  tab", function () {
    ...
    it("should open  assignment dashboard", async function () {
      // Wait for the button element to be located
      const discussionButton = await driver.wait(
        until.elementLocated(
          By.xpath("/html/body/div/div/div/div[1]/button[5]")
        ),
