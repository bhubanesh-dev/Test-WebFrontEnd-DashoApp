...
export default async function closeClassesDashBoard(driver) {
  describe("close class view dashboard", function () {
    ...
    it("should close dashboard", async function () {
      // Wait for the button element to be located
      const discussionButton = await driver.wait(
        until.elementLocated(
          By.xpath("/html/body/div/div/div/div[2]/div/div/div[4]/div/button")
        ),
